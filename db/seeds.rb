...
message10 = BreakupMessage.create(topic: theme4, tone: 'uncomfortable', subject: 'something they said', message: "Hi, I want to be honest with you. What you said on our date was not okay. I do not see this going anywhere. Thanks for understanding.")
message11 = BreakupMessage.create(topic: theme4, tone: 'uncomfortable', subject: 'inappropriate behavior/physical behaviour', message: "Hi, I want to be honest with you. What you did on our date was not okay and made me very uncomfortable. I do not see this going anywhere and please do not contact me.")
message12 = BreakupMessage.create(topic: theme4, tone: 'uncomfortable', subject: 'rude/Inconsiderate', message: "Hi, I want to be honest with you. I do not see us going any further. Thanks for understanding.")
